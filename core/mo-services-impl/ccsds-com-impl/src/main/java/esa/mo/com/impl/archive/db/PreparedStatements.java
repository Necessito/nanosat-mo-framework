...
public class PreparedStatements {
    ...
    private static String SELECT_ALL_COM_OBJECTS = "SELECT objId " + "FROM COMObjectEntity "
    ...
    private PreparedStatement selectAllCOMObjects;
    ...
    public void init() throws SQLException {
        selectAllCOMObjects = c.prepareStatement(SELECT_ALL_COM_OBJECTS);
    ...
    public PreparedStatement getSelectAllCOMObjects() {
        return this.selectAllCOMObjects;
    }
